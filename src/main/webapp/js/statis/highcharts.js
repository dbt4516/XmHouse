...
// default adapters below.
 ...
 defaultOptions = {
  ...
  chart: {
   ...
   //spacingLeft: 10,
   //style: {
   fontFamily: '"Microsoft YaHei",微软雅黑,"MicrosoftJhengHei",华文细黑,'+'"Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif', // default font
   //	fontSize: '12px'
   //},
 ...
 SVGRenderer.prototype = {
  ...
  getStyle: function (style) {
   return (this.style = extend({
    fontFamily: '"Microsoft YaHei",微软雅黑,"MicrosoftJhengHei",华文细黑,'+'"Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif', // default font'"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif', // default font
    fontSize: '12px'
   }, style));
  },
