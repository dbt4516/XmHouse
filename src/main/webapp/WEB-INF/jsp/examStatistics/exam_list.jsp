...
<script>
    $(function () {
        ...
        $('#search').click(function () {
            load(0);
            $.get('${pageContext.request.contextPath}/examStatistics/ajax/examQuery', {
        ...
        function setOptions(data) {
            ...
            var op = '<td><a href="${absolute.request.contextPath}/examStatistics/exam/person/' + value.eid + '">查看详情</a></td>';
                str='<tr class="m-tr"><td>'+value.eName+'</td><td>'+value.count+'</td><td>'+value.failCount +'</td><td>'+value.passCount+'</td><td>'+value.passRate+'</td><td>'+value.leaveCount+'</td><td>'+UnixToDate(value.ust)+'</td><td>'+UnixToDate(value.uet)+'</td>' + op;
                $("#m-tbody").append(str);
            });
        }
